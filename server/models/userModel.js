...
mongoose
  ...
  .then(() => log.info('Connected to Mongo DB Successfully'))
...
const User /*: { username: String, password: String }*/ = mongoose.model(
  'user',
  userSchema
);
...
const GithubUser /*: { githubId: String, username: String }*/ = mongoose.model(
  'githubUser',
  githubSchema
);
...
const GoogleUser /*: { googleId: String, username: String }*/ = mongoose.model(
  'googleUser',
  googleSchema
);
