...
//***DEPRECATED ****//Github page says that the code will archived and will be READ ONLY!
//NEED REPLACEMENT for drag and drop features!!!!
import { DragDropContext, Droppable, DropResult } from 'react-beautiful-dnd';
import styles from './TestCase.module.scss';
import { ReduxTestCaseContext } from '../../context/reducers/reduxTestCaseReducer';

import {
  addActionCreator, //test case block in jest
  addAsync, //check to see how async block is formatted
  addMiddleware, //mocking the req, res, next objects
  addReducer, //testing reducers
  updateReduxTestStatement, //describe block
} from '../../context/actions/reduxTestCaseActions';
import ReduxTestMenu from '../TestMenu/ReduxTestMenu';
import ReduxTestStatements from './ReduxTestStatements'; //react component for rendering test blocks
import { ReduxStatements } from '../../utils/reduxTypes'; //types that goes into our test statements
...
const ReduxTestCase = () => {
  ...
  //update top describe statement when input changes
  ...
  //helper function to update indicies when test statements are dragged and dropped
  const reorder = (
  ...
  //dispatching actions to add new test blocks
  ...
  return (
    <div>
      ...
      {/*Decribe,it,action,assertion blocks */}
      <ReduxTestStatements />
    </div>
  );
};
